(()=>{
  ...
  function css(){
    ...
    s.textContent=`
      ...
      .staff-reservation-row .tour-row-actions{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:10px!important;align-items:stretch!important;justify-items:stretch!important;width:100%!important;max-width:540px!important;margin:10px 0 0!important;padding:0!important;box-sizing:border-box!important;grid-column:1 / -1!important;clear:both!important}
      .staff-reservation-row .tour-row-actions .tour-print-button,.staff-reservation-row .tour-row-actions .reservation-manage-button,.staff-reservation-row .tour-row-actions .tour-enroll-button{width:100%!important;min-width:0!important;max-width:none!important;height:58px!important;min-height:58px!important;margin:0!important;padding:8px 10px!important;border-radius:12px!important;box-sizing:border-box!important;display:flex!important;align-items:center!important;justify-content:center!important;text-align:center!important;font-size:14px!important;line-height:1.25!important;font-weight:800!important;white-space:normal!important;overflow-wrap:anywhere!important}
      ...
      @media (min-width:701px) and (max-width:1100px){.staff-reservation-row .tour-row-actions{max-width:none!important;width:100%!important;gap:8px!important}.staff-reservation-row .tour-row-actions .tour-print-button,.staff-reservation-row .tour-row-actions .reservation-manage-button,.staff-reservation-row .tour-row-actions .tour-enroll-button{font-size:13px!important;padding:8px 6px!important}}
      @media (max-width:700px){.staff-reservation-row .tour-row-actions{grid-template-columns:1fr!important;width:100%!important;max-width:none!important;gap:8px!important;margin-top:10px!important}.staff-reservation-row .tour-row-actions .tour-print-button,.staff-reservation-row .tour-row-actions .reservation-manage-button,.staff-reservation-row .tour-row-actions .tour-enroll-button{width:100%!important;min-width:0!important;height:48px!important;min-height:48px!important;font-size:14px!important}}
    `;
